...
int main (int argc, char ** argv)
{
  ...
  std::vector<RealD> masses({0.00046, 0.0232}); //3GeV
  ...
  for(auto mass: masses) {
    ...
    p1.twist_n_2pi_L = AcceleratorVector<Real,Nd>({-0.25,0,0.25,0});
    p2.twist_n_2pi_L = AcceleratorVector<Real,Nd>({0,0.25,0.25,0}); 
  ...
  nprfilename_ml += "_npr_res_ml_0.25twist";
  ...
  nprfilename_ms += "_npr_res_ms_0.25twist";
